    ...
    <div className='px-7 md:px-10 mt-14 md:h-screen'>
      <div className='w-full flex flex-col md:flex-row items-center justify-between'>
        <div className='text-white my-10 md:mt-0'>
          ...
          <div className='mt-10'>
            <a href="/assets/files/CV_Nicolas.pdf" download="CV Nicolas" className='btn font-semibold outline-none bg-blue-400 py-2.5 px-4 text-white rounded-lg hover:bg-white hover:text-blue-400 transition-all duration-500'>Download CV</a>
            <Link
              activeClass="active"
              to="experience"
              spy={true}
