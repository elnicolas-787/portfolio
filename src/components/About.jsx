    ...
    <div className="px-7 md:px-10 sm:mt-20 md:-mt-52" id="about">
      <div className="max-w-7xl mx-auto pt-20">
        ...
        <p className="text-white my-2 md:w-2/3 leading-[2]">
          ...
          Fullstack web developer, UI designer, and Mobile developer. I have
          honed my skills in web Development and advance i have core
          understanding of advance UI design principales. Here are the major
          skills i have.{" "}
        </p>
